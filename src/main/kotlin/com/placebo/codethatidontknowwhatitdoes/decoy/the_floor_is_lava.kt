...
//
// Class name : TheFloorIsLava
// Display name: the_floor_is_lava
// ═══════════════════════════════════════════════════════════════════════════
...
class TheFloorIsLava : coide("the_floor_is_lava") { //does absolutely nothing i just wanted more modules
