...
//
// Class name : HitboxShrink
// Display name: HitboxShrink
// ═══════════════════════════════════════════════════════════════════════════
...
class HitboxShrink : coide("HitboxShrink") { //absolutely zero functionality guaranteed
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // the entire logic was here but i deleted it
