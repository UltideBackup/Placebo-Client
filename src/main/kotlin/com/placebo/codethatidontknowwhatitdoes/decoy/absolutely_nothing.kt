...
//
// Class name : AbsolutelyNothing
// Display name: absolutely_nothing
// ═══════════════════════════════════════════════════════════════════════════
...
class AbsolutelyNothing : coide("absolutely_nothing") { //module that claims to do a thing
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // i wrote this name then immediately gave up
    }
}
