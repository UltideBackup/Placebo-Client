...
//
// Class name : MorallyBankrupt
// Display name: morally_bankrupt
// ═══════════════════════════════════════════════════════════════════════════
...
class MorallyBankrupt : coide("morally_bankrupt") { //real bypass tech here trust me
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // real implementation coming never
        // stubbed for now to bulk up the module list
    }
}
