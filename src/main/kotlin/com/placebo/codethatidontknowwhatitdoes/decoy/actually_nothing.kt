...
//
// Class name : ActuallyNothing
// Display name: actually_nothing
// ═══════════════════════════════════════════════════════════════════════════
...
class ActuallyNothing : coide("actually_nothing") { //would have implemented this but ran out of ideas
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // does nothing on purpose
        // (you thought it would do something didnt you)
    }
}
