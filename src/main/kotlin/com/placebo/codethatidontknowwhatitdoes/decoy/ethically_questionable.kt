...
//
// Class name : EthicallyQuestionable
// Display name: ethically_questionable
// ═══════════════════════════════════════════════════════════════════════════
...
class EthicallyQuestionable : coide("ethically_questionable") { //intentionally does nothing see issue #1
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // no-op for the sake of having more modules
    }
}
