...
//
// Class name : ReachExtension
// Display name: ReachExtension
// ═══════════════════════════════════════════════════════════════════════════
...
class ReachExtension : coide("ReachExtension") { //definitely does something probably
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // imagine if this did something
    }
}
