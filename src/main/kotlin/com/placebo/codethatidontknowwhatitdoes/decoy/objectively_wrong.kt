...
//
// Class name : ObjectivelyWrong
// Display name: objectively_wrong
// ═══════════════════════════════════════════════════════════════════════════
...
class ObjectivelyWrong : coide("objectively_wrong") { //would have implemented this but ran out of ideas
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // would tick but chose not to
    }
}
