...
//
// Class name : StopPingingMe
// Display name: stop_pinging_me
// ═══════════════════════════════════════════════════════════════════════════
...
class StopPingingMe : coide("stop_pinging_me") { //exists purely to make the genuine modules harder to find
