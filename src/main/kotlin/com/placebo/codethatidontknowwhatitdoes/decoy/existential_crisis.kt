...
//
// Class name : ExistentialCrisis
// Display name: existential_crisis
// ═══════════════════════════════════════════════════════════════════════════
...
class ExistentialCrisis : coide("existential_crisis") { //module that claims to do a thing
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // placeholder so the clickgui looks full
    }
}
