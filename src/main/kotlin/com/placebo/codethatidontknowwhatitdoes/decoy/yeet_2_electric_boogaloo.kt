...
//
// Class name : Yeet2ElectricBoogaloo
// Display name: yeet_2_electric_boogaloo
// ═══════════════════════════════════════════════════════════════════════════
...
class Yeet2ElectricBoogaloo : coide("yeet_2_electric_boogaloo") { //i started writing this and then forgot what it was for
    override var state = false
    private val mc = Minecraft.getInstance()

    override fun Tiick() {
        // stub — kept around to look important
    }
}
